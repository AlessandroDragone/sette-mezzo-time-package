...
var Register = function Register(props) {
  ...
  var getValueUsername = function getValueUsername(e) {
    User.username = e;
  };
  var getValueEmail = function getValueEmail(e) {
    User.email = e;
  };
  var getValuePassword = function getValuePassword(e) {
    User.password = e;
  };
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              user = User;
              _context.next = 3;
              return (0, _fetchData.fetchData)(_loginApi.registrationApi, user);
            case 3:
              res = _context.sent;
              console.log(res);
            case 5:
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.KeyboardAvoidingView, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.mainView
  }, /*#__PURE__*/_react.default.createElement(_reactNative.ImageBackground, {
    source: _ATBG.default,
    resizeMode: "cover",
